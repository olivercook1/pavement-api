...
public class DesignHintsController {
	...
	@Operation(operationId = "designHints", summary = "Get design hints")
	@GetMapping("/api/design/hints")
	...
	public DesignHints hints() {
		...
		h.foundationOptions = List.of(new DesignHints.Option("SUBBASE_ONLY_UNBOUND", "Subbase only — Unbound"),
		...
		h.notes = List.of("CD 226 Eq 2.24 sets asphalt; T ≥ 80 msa ⇒ 180 mm asphalt.",
